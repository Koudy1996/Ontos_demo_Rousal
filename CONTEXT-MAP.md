...
| [Inventory](docs/contexts/inventory/CONTEXT.md) | Stock Items, Stock Locations/Positions, Stock Requirements, physical stock evidence, Reservations, Commitment Protection, stock obligations, or Inventory migration |
