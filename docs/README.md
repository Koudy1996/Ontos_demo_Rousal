...
| Inventory stock identity and reservation safety | [ADR-0023](adr/0023-inventory-reservation-authority-and-commitment-fence.md) and [ADR-0024](adr/0024-inventory-demand-before-stock-allocation.md)                                                     | [Inventory context](contexts/inventory/CONTEXT.md)                                                                            |
