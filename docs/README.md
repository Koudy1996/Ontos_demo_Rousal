...
| Inventory stock identity and reservation safety | [ADR-0023](adr/0023-inventory-reservation-authority-and-commitment-fence.md), [ADR-0024](adr/0024-inventory-demand-before-stock-allocation.md), and [ADR-0026](adr/0026-single-inventory-backend-and-reservation.md)                                                               | [Inventory context](contexts/inventory/CONTEXT.md)                                                                            |
| Consent and privacy semantics               | Current product decisions in the #509 planning/specification tree, constrained by accepted cross-module, authorization, evidence, and MicroVertical ADRs                                              | [Consent + Privacy context](contexts/privacy/CONTEXT.md)                                                                    |
