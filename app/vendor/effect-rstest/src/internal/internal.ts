...
const runPromise: <E, A>(_: Effect.Effect<A, E, never>, ctx?: Rs.TestContext | undefined) => Promise<A> =
  Effect.fnUntraced(
...
export const addEqualityTesters = () => {
  Rs.expect.addEqualityTesters([(a, b) => (Equal.isEqual(a) && Equal.isEqual(b) ? Equal.equals(a, b) : undefined)]);
};
...
const makeItProxy = <Methods extends object>(it: Rs.TestAPIs, overrides: Methods): Methods & Rs.TestAPIs =>
