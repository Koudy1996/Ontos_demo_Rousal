...
const EXPECTED_MIGRATION_JOURNALS = [
  ...
  '__drizzle_migrations_billing_documents',
  ...
  '__drizzle_migrations_workforce',
] as const;
...
const ownerVerifierPaths = [
  ...
  '../verticals/price-group-catalog/scripts/verify-db-schema.mts',
  ...
  '../verticals/billing-documents/scripts/verify-db-schema.mts',
] as const;
