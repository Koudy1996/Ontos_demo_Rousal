...
import { workforceI18nResources } from './i18n/resources.ts';
...
const resources = {
  cs: { ...workforceI18nResources.cs, translation: csResource },
  en: { ...workforceI18nResources.en, translation: enResource },
} as const;
