...
export const workforceCors = (shellOrigin: string) =>
  HttpRouter.cors({
    allowedHeaders: [
      'Accept',
      'Accept-Language',
...
export const WorkforceCorsLive = Layer.unwrap(Config.string('ONTOS_GATEWAY_ISSUER').pipe(Effect.map(workforceCors)));
