/* oxlint-disable perfectionist/sort-interfaces -- These JSON-LD helper inputs mirror schema.org field order for the generated route helper contract. expires: 2027-03-31. */
export type JsonLdPrimitive = string | number | boolean | null;
export type JsonLdValue = JsonLdPrimitive | readonly JsonLdValue[] | { readonly [key: string]: JsonLdValue };
...
export const webApplicationJsonLd = (input: WebApplicationJsonLdInput) => withSchemaContext('WebApplication', input);
...
export const organizationJsonLd = (input: OrganizationJsonLdInput) => withSchemaContext('Organization', input);
