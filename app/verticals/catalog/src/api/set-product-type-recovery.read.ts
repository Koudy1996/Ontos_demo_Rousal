...
export const recoverSetProductType = Effect.fn('SetProductTypeRecoveryRead.recover')(function* recover(
...
export const setProductTypeRecoveryEntrypoint = defineTenantModuleEntrypoint({
  access: 'read',
