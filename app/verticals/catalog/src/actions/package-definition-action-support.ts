...
/** Current-basis verification is not installed yet. The service itself fails closed without it. */
export const packageDefinitionPersistenceServiceFactory = (...args: Parameters<typeof packagePersistenceForScope>) =>
  Effect.succeed(packagePersistenceForScope(...args));
