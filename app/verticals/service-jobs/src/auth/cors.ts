...
export const serviceJobCors = (shellOrigin: string) =>
  HttpRouter.cors({
    allowedHeaders: [
      'Accept',
      'Accept-Language',
...
export const ServiceJobCorsLive = Layer.unwrap(Config.string('ONTOS_GATEWAY_ISSUER').pipe(Effect.map(serviceJobCors)));
