...
import { serviceJobsI18nResources } from './i18n/resources.ts';
...
const resources = {
  cs: { ...serviceJobsI18nResources.cs, translation: csResource },
  en: { ...serviceJobsI18nResources.en, translation: enResource },
} as const;
