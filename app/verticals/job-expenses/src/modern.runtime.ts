...
import { jobExpensesI18nResources } from './i18n/resources.ts';
...
const resources = {
  cs: { ...jobExpensesI18nResources.cs, translation: csResource },
  en: { ...jobExpensesI18nResources.en, translation: enResource },
} as const;
