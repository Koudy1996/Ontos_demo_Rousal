...
export default defineConfig({
  projects: [
    {
      clearMocks: true,
      extends: withModernConfig({ configPath: './modern-rstest.config.ts' }),
    ...
    { include: ['tests/integration/**/*.test.ts'], name: 'integration', testEnvironment: 'node', testTimeout: 30_000 },
    { include: ['tests/unit/**/*.test.ts'], name: 'unit', testEnvironment: 'node', tools: { swc } },
  ],
});
