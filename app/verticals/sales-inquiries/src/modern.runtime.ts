...
import { salesInquiriesI18nResources } from './i18n/resources.ts';
...
const resources = {
  cs: { ...salesInquiriesI18nResources.cs, translation: csResource },
  en: { ...salesInquiriesI18nResources.en, translation: enResource },
} as const;
