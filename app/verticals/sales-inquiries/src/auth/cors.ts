...
export const salesInquiryCors = (shellOrigin: string) =>
  HttpRouter.cors({
    allowedHeaders: [
      'Accept',
      'Accept-Language',
...
export const SalesInquiryCorsLive = Layer.unwrap(
  Config.string('ONTOS_GATEWAY_ISSUER').pipe(Effect.map(salesInquiryCors)),
);
