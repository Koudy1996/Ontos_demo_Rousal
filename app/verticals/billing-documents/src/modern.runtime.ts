...
import { billingDocumentsI18nResources } from './i18n/resources.ts';
...
const resources = {
  cs: { ...billingDocumentsI18nResources.cs, translation: csResource },
  en: { ...billingDocumentsI18nResources.en, translation: enResource },
} as const;
