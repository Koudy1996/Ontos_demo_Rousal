...
export const commerceQuantityRuleRevisions = commerceCustomerContextSchema.table.withRLS(
  'commerce_quantity_rule_revisions',
  {
    ...
    quantityTargetDivisibilityRevision: integer('quantity_target_divisibility_revision').notNull(),
    quantityTargetModuleId: text('quantity_target_module_id').notNull(),
    quantityTargetResourceId: text('quantity_target_resource_id').notNull(),
    quantityTargetResourceType: text('quantity_target_resource_type').notNull(),
    quantityTargetTenantId: uuid('quantity_target_tenant_id').notNull(),
    ...
    quantityUnitRuleRevision: integer('quantity_unit_rule_revision').notNull(),
  ...
  (table) => [
    ...
    check(
      ...
      sql`${table.quantityTargetModuleId} = 'commerce.catalog' and ${table.quantityTargetResourceType} in ('commerce.catalog.variant', 'commerce.catalog.package-definition') and ${table.quantityTargetTenantId} = ${table.tenantId} and ${table.quantityTargetDivisibilityRevision} between 1 and 2147483647 and ${table.quantityUnitModuleId} = 'commerce.catalog' and ${table.quantityUnitResourceType} = 'commerce.catalog.product-unit' and ${table.quantityUnitTenantId} = ${table.tenantId} and ${table.quantityUnitRuleRevision} between 1 and 2147483647`,
    ),
    check(
    ...
    trimmed('ccc_quantity_rule_target_resource_ck', table.quantityTargetResourceId),
